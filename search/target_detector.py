...
def train_and_gate(out=None, n_rooms=6, train_seed0=600000, test_seed0=610000, thr=0.5):
    ...
    Returns the detection scorecard (AUC, precision, recall, obstacle
    false-alarm)."""
    ...
    # obstacle false-alarm: fire rate on obstacle-facing, no-target frames
...
def main() -> None:
    ...
    if args.selftest or not args.train:
        selftest()
        return
    r = train_and_gate(args.train, args.n_rooms)
    print(
