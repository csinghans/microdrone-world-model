...
export const siteCopy: Record<Locale, SiteCopy> = {
  "zh-TW": {
    ...
    limits: {
      ...
      items: [
        { title: "仍是 simulation", description: "真機硬體仍 parked；72/100 與 91/100 不能寫成實機可靠度。" },
  ...
  en: {
    ...
    limits: {
      ...
      items: [
        { title: "Still simulation", description: "Hardware remains parked; 72/100 and 91/100 are not real-flight reliability." },
